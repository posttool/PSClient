package com.pagesociety.ux.component.form
{
    ...
    public class LabeledInt extends LabeledEditor implements IEditor
    {
        private var _input:IntEditor;
        
        public function LabeledInt(parent:Container, fieldname:String, label:String, fs_label:String=null, fs_input:String=null)
        {
            super(parent,fieldname,label,fs_label);
            
            _input = new IntEditor(this);
            if (fs_input!=null)
        ...
        public function get input():IntEditor
        {
            return _input;
        }
